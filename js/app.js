...
for (let i = 0; i < links.length; i++) {
   ...
   el.addEventListener('click', function (e) {
      ...
      window.scrollTo(0, 0);
      let elementPosition = target_block.getBoundingClientRect().top;
...
let videoItem = videoBtn.parentElement;
let closeBtn = videoItem.querySelector('.video__close');
...
if (video) {
   ...
   closeBtn.addEventListener('click', function (e) {
      ...
      video.pause();
      setTimeout(function () {
         videoItem.classList.remove('_hide');
...
let inputsPhone = document.querySelectorAll('._phone');
...
let formBtn = document.querySelectorAll('.form-data__btn');
console.log(formBtn);

if (formBtn.length > 0) {
   for (let i = 0; i < formBtn.length; i++) {

      formBtn[i].addEventListener("click", function (e) {
         e.preventDefault();

         let itemForBtn = formBtn[i].parentElement;
         let formForBtn = itemForBtn.parentElement;
         let inputPhone = formForBtn.querySelector('._phone');

         if (inputPhone.value == "") {
            inputPhone.style.cssText = "border: 1px solid red; opacity: 0.6;";
         } else {
            inputPhone.style.cssText = "border: none;";
